...
List<AcceptedEmployee> acceptedEmployeeFromJson(String str) =>
    List<AcceptedEmployee>.from(
        json.decode(str).map((x) => AcceptedEmployee.fromJson(x)));

String acceptedEmployeeToJson(List<AcceptedEmployee> data) =>
...
class AcceptedEmployee {
  ...
  factory AcceptedEmployee.fromJson(Map<String, dynamic> json) =>
      AcceptedEmployee(
        id: json["id"],
  ...
  @override
  String toString() {
    return 'AcceptedEmployee(id: $id, accepted: $accepted, employee: ${employee.name}, job: ${job.title})';
  }
}
